 ...
 * @author ozgur
 */
public class LogsList extends javax.swing.JFrame {
    ...
    public LogsList() {
        initComponents();
        IAdmin logsList = new OracleAdminDal();
        logsList.populateTableLogs(tblLogsList);
    }
    ...
    private void initComponents() {
        ...
        tblLogsList = new javax.swing.JTable();
        ...
        tblLogsList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Log ID", "Log Tipi", "İlişikili Tablo", "İlişkili ID", "Log Tarihi"
            }
        ) {
        ...
        jScrollPane1.setViewportView(tblLogsList);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogsList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblLogsList;
